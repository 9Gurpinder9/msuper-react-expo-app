// frontend/app/(app)/company/bookmark-categories/index.tsx
...
export default function CompanyBookmarkCategories() {
  ...
  const renderTableHeader = () => (
    <View style={styles.tableHeader}>
      ...
      <View style={[styles.headerCell, styles.cellName]}>
        <Text style={styles.headerText}>Bookmark Category Name</Text>
      </View>
    ...
    <View style={styles.tableRow}>
      ...
      <View style={[styles.tableCell, styles.cellActionT, { borderRightWidth: 0, alignItems: 'center' }]}>
        <Button
          ...
          compact
          onPress={() => router.push({ pathname: '/company/bookmark-categories/edit-bookmark-category', params: { id: item.id, name: item.name } })}
  ...
  return (
    <View style={styles.wrapper}>
      ...
      {isLoading ? (
        <AppLoader message="Loading bookmark categories..." icon="database-sync-outline" />
      ) : viewMode === 'table' ? (
      ...
      <FAB
        ...
        onPress={() => router.push('/company/bookmark-categories/add-bookmark-category')}
